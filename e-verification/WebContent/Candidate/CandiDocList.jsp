...
<div class="container-fluid">
    ...
    <h1>Documents of <%=ul1.get(0)%> </h1><br/>  
	<div id="myDIV" >
		<div class="container-fluid">
     	<div class="row " style="height:430px; ">
			<div class="col-12">
				<div class="row " style="">
					...
					<div class="col-2"style="border: solid 1px black;" >Apply for Verification</div>
					<div class="col-2"></div>
				</div>
	...
	{ 
		...
		<div class="row" style="height: 25px">
			...
			<div class="col-2"style="border: solid 1px black;" ><%= u.getDocPath() %></div>
			<div class="col-2"></div>
		</div>
	<% } %>	 
			</div>
